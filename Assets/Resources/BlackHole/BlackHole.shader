Shader "Custom/BlackHole"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            static const float maxFloat = 3.3028823466e+38;
            ...
            float4 frag (v2f IN) : SV_Target
            {
                ...
                float2 finalUV = uv * _DiscTex_ST.xy + _DiscTex_ST.zw;
                float texCol = _DiscTex.SampleLevel(sampler_DiscTex, finalUV, 0).r;
